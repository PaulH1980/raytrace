...
//#define STATESYSTEM_USE_DEPRECATED 1
...
namespace RayTrace
{
    ...
    static inline GLbitfield getBit(GLuint key)
    {
        return (1 << key);
    }
    ...
    struct StencilState {
        ...
        StencilState()
        {
            for (GLuint i = 0; i < MAX_FACES; i++) {
                ...
                funcs[i].refvalue = 0;
                funcs[i].mask =static_cast<GLuint>( ~0 );
            }
        }
    ...
    struct PrimitiveState {
        ...
        PrimitiveState() {
            restartIndex = static_cast<GLuint>(~0);
            patchVertices = 3;
    ...
    */
    ...
    struct MaskState {
        ...
        MaskState() {
            ...
            depth = GL_TRUE;
            stencil[FACE_FRONT] = static_cast<GLuint>(~0);
            stencil[FACE_BACK] = static_cast<GLuint>(~0);
            for (GLuint i = 0; i < MAX_DRAWBUFFERS; i++) {
        ...
        void SetColorMask(int _bufferIdx, bool _r, bool _g, bool _b, bool _a);
    ...
    struct EnableState {
        ...
        union {
            ...
            struct fields {
                GLbitfield  blend : 1;
                GLbitfield  color_logic_op : 1;
                GLbitfield  cull_face : 1;
                GLbitfield  depth_clamp : 1;
                GLbitfield  depth_test : 1;
                GLbitfield  dither : 1;
                GLbitfield  framebuffer_srgb : 1;
                GLbitfield  line_smooth : 1;
                GLbitfield  multisample : 1;
                GLbitfield  polygon_offset_fill : 1;
                GLbitfield  polygon_offset_line : 1;
                GLbitfield  polygon_offset_point : 1;
                GLbitfield  polygon_smooth : 1;
                GLbitfield  primitive_restart : 1;
                GLbitfield  primitive_restart_fixed_index : 1;
                GLbitfield  rasterizer_discard : 1;
                GLbitfield  sample_alpha_to_coverage : 1;
                GLbitfield  sample_alpha_to_one : 1;
                GLbitfield  sample_coverage : 1;
                GLbitfield  sample_shading : 1;
                GLbitfield  sample_mask : 1;
                GLbitfield  stencil_test : 1;
                GLbitfield  scissor_test : 1;
                GLbitfield  texture_cube_map_seamless : 1;
                GLbitfield  program_point_size : 1;
            } field;
        };
    ...
    struct RenderState {
        ...
        RenderState* Clone() {
            RenderState* cloned = new RenderState(*this);
            return cloned;
        }
    };
    ...
    public:
        ...
        void          set(StateID id, const RenderState& state, GLenum basePrimitiveMode);
        const RenderState&  get(StateID id) const;
      ...
      //  static  makeDiff(const State& _from, const State& _to, StateDiff& _result);
        ...
        void  makeDiff(StateDiff& diff, const RenderState& from, const RenderState& to) const;

        void  makeDiff(StateDiff& diff, const StateInternal& fromInternal, const StateInternal& toInternal) const;
        void  applyDiffGL(const StateDiff& diff, const RenderState& to, bool skipFboBinding);
